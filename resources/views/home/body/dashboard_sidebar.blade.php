    ...
    <div class="sidebar-menu__inner">
        ...
        <ul class="sidebar-menu-list">
            <li class="sidebar-menu-list__item">
                <a href="//realvest/user/dashboard" class="sidebar-menu-list__link active">
                    <span class="icon"><i class="fas fa-th-large"></i></span>
                    <span class="text">Dashboard</span>
                </a>
            </li>
            <li class="sidebar-menu-list__item">
                <a href="//realvest/user/invest/history" class="sidebar-menu-list__link ">
                    <span class="icon"><i class="fas fa-dolly-flatbed"></i></span>
                    <span class="text">My Investments</span>
                </a>
            </li>
            <li class="sidebar-menu-list__item">
                <a href="//realvest/user/profit/history" class="sidebar-menu-list__link ">
