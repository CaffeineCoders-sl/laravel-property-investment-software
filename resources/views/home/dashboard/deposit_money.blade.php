 ...
 <div class="dashboard-body">
        ...
        <div class="col-lg-12">
            <form action="//realvest/user/deposit/insert" method="post" class="deposit-form">
                <input type="hidden" name="_token" value="AgrQteztDPUt9ULMougURIKUlrFDk0lPkode5Rzl" autocomplete="off">                <input type="hidden" name="currency">
   ...
   <label for="2checkout_-_usd" class="payment-item  gateway-option">
    ...
    <input class="payment-item__radio gateway-input" id="2checkout_-_usd" value="122"
        checked  data-min-amount="$1.00"  type="radio" data-max-amount="$10,000.00">
</label>
  ...
  <label for="aamarpay_-_bdt"
    ...
    <input class="payment-item__radio gateway-input" id="aamarpay_-_bdt" type="radio" name="gateway" value="125" data-min-amount="$1.00"
        data-max-amount="$10,000.00">
                        ...
                        <div class="col-lg-6">
                            <div class="payment-system-list p-3">
                                ...
                                <button type="submit" class="btn btn--base w-100" disabled>  Deposit Confirm                                                                    </button>
